        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    ...
                    try {
                        ...
                        if (librosDTO.isEmpty()) {
                            System.out.println("ERROR: Libro no encontrado en la API");
                        } else {
                            ...
                            for (LibroDTO libroDTO : librosDTO) {
                                if (libroDTO.getTitulo().equalsIgnoreCase(titulo)) {
                                    ...
                                    if (libroExistente.isPresent()) {
                                        System.out.println("ERROR: El titulo " + titulo + " ya existe");
                                        System.out.println("ERROR: No es posible registrar el mismo libro más de una vez");
                            ...
                            if (!libroRegistrado) {
                                System.out.println("ERROR: No se ha encontrado el libro '" + titulo + "' en la API");
                            }
                        }
                    } catch (Exception e) {
                ...
                case 5:
                    ...
                    break;
                case 0:
                    System.out.println("Saliendo... ¡Gracias por utilizar LiterAlura!");
                    break;
                default:
